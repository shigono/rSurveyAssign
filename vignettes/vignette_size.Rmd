...
- `nCAT_MAX`, `sCAT_TYPE`, `sCAT_FILTER`, `sCAT_ORDER`, `sCAT_EXCLUDE`: カテゴリの割付方法。
    - ["How to assign subjects"](vignette_assign.html)を参照して下さい。
- `nSLOT_MAX`, `sSLOT_TYPE`, `sSLOT_FILTER`, `sSLOT_ORDER`, `sSLOT_EXCLUDE`: スロットの割り付け方法。
    - ["How to assign subjects"](vignette_assign.html)を参照して下さい。
