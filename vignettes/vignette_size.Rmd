...
カテゴリ・スロットの割付方法については ["1. How to assign subjects"](vignette_assign.html)を参照して下さい。
...
すべてのスロットにおいて目標対象者数が満たされ、調査が終了しました。
...
```
カテゴリ1, 2, 3の割付人数は、平均してそれぞれ約383人, 420人, 310人となりました。
...
割付人数が目標である10人を超えるのは、スロット割付の絞り込み条件を`all`にしたため、
...
たとえば、スロット割付の方法を(`adaptive`,`all`,`random`,`allclosed`)に変更して
シミュレーションしてみます。
...
スロット割付方法を(`adaptive`,`all`,`shortnum`,`allclosed`)としたときの調査対象者数の平均は約525人でしたから、
